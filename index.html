...
<html lang="en">
  <head>
    ...
    <title>AMADOU TRAORE Business Card</title>
    ...
    <meta property="og:title"         content="Digital Business Card for AMADOU TRAORE" />
    <meta property="og:description"   content="AMADOU TRAORE • Full stack web & mobile solutions architect, Cloud & DevOps Advisor , Penetration Tester , Bug Bounty Hunter , Ethical Hacker, Supply Chain Manager (Stock Manager) ...." />
    <meta property="og:image"         content="walletcard.png" />
    <link rel="image_src"             href="walletcard.png" />

	<link rel="profile" href="http://microformats.org/profile/hcard">
	<link rel="software" href="https://amadou-python3.herokuapp.com/">
  ...
  <body>
  	<div class="container vcard">
			...
			<div id="buttons">
				<div class="row">
					...
					<div class="col-xs-6 col-sm-3 col-sm-offset-6 column" id="wallet-badge">
						<p class="text-center"><a href="vcard.vcf"><img src="resources/img/add-to-wallet-badge.png" alt="Add to Wallet"/></a></p>
					</div>
				</div>
			</div>
		...
		<div class="section row" id="footer">
			<hr/>
			<p class="text-center"><a href="https://github.com/Amadou-python3">AMADOU TRAORE Business Card </a> says: save trees, spread the bits, think mobile, act mobile.</p>
		</div>
	</div>
